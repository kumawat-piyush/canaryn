...
export interface ListGlobalTemplatesQueryParams {
  ...
  limit?: number
  /**
   * The substring which is used to filter global templates by their name.
   */
  query?: string
}

export type ListGlobalTemplatesProps = Omit<
  GetProps<TypesTemplate[], UsererrorError, ListGlobalTemplatesQueryParams, void>,
  'path'
>
...
export type UseListGlobalTemplatesProps = Omit<
  UseGetProps<TypesTemplate[], UsererrorError, ListGlobalTemplatesQueryParams, void>,
  'path'
>
