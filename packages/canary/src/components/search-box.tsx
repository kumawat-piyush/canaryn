...
const Root = ({
  ...
  return (
    <div className={cn('relative', width === 'full' ? 'w-full' : 'w-96', className)}>
      ...
      />
      {hasShortcut && (
        <div className="text-tertiary-background shadow-border absolute right-2.5 top-1/2 flex -translate-y-1/2 transform cursor-pointer items-center gap-0.5 rounded-sm px-1.5 opacity-80 shadow-[0_0_0_1px] duration-100 ease-in-out hover:opacity-100">
