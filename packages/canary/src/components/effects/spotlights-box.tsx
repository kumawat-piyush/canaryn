  ...
  return (
    <div
      ...
      <canvas
        ...
        width="100%"
        height="100%"
        className="absolute inset-0 h-full w-full rounded-lg brightness-110 duration-150 ease-in-out group-hover:brightness-125"
      />
      <div className="bg-background/40 absolute inset-[1px] rounded-lg" />
